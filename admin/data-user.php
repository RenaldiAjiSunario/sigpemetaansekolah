        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <table class="table">
                    <tr>
                        <td colspan="7"><a href="tambah-user" class="btn btn-warning">Tambah Data</a></td>
                    </tr>
                    <tr>
                        <th>No.</th><th>Nama</th><th>Username</th><th>Password</th><th>Role</th><th colspan="2">Aksi</th>
                    </tr>
                    <?php 
                        ...
                        $data_2 = mysqli_query($koneksi,"select * from tb_user limit $halaman_awal, $batas");
                    ...
                    <tr>
                        ...
                        <td><a href="ubah-data-user?id_user=<?php echo $d['id_user']; ?>" class="btn btn-success">Ubah</a></td>
                        <td><a href="hapus-data-user?id_user=<?php echo $d['id_user']; ?>" class="btn btn-danger" onclick="return confirm('Hapus Data ?');">Hapus</a></td>
                    </tr>
                    <?php } ?>
                    </table>
