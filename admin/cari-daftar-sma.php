        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <table class="table">
                    <tr>
                        <td colspan="9"><a href="tambah-pemetaan" class="btn btn-warning">Tambah Data</a></td>
                    </tr>
                    <tr>
                        <th>No.</th><th>Nama</th><th>Alamat</th><th>Lattitude</th><th>Longitude</th><th>Profil</th><th>Detail</th><th colspan="2">Aksi</th>
                    </tr>
                    <?php 
                        ...
                        $data = mysqli_query($koneksi,"select * from tb_daftar_sma where nama_sma like '%$nama_sma%'");
                        $jumlah_data = mysqli_num_rows($data);
                        $total_halaman = ceil($jumlah_data / $batas);
                        
                        $data_2 = mysqli_query($koneksi,"select * from tb_daftar_sma where nama_sma like '%$nama_sma%' limit $halaman_awal, $batas");
                        $nomor = $halaman_awal+1;
                        $no = 1;
                        while($d = mysqli_fetch_array($data_2)){ ?>
                    <tr>
                        <td><?php echo $no ++ ?></td>
                        <td><?php echo $d['nama_sma']; ?></td>
                        <td><?php echo $d['alamat_sma']; ?></td>
                        <td><?php echo $d['lattitue']; ?></td>
                        <td><?php echo $d['longitude']; ?></td>
                        <td><img src="../gambar_profil_sma/<?php echo $d['foto_profil_sma']; ?>" width="100px" height="120px" alt=""></td>
                        <td><a href="data-detail-daftar-sma?id_daftar_sma=<?php echo $d['id_daftar_sma']; ?>" class="btn btn-secondary">Lihat</a></td>
                        <td><a href="data-fasilitas?id_daftar_sma=<?php echo $d['id_daftar_sma']; ?>" class="btn btn-warning">Fasilitas</a></td>
                        <td><a href="ubah-data-pemetaan?id_daftar_sma=<?php echo $d['id_daftar_sma']; ?>" class="btn btn-success">Ubah</a></td>
                        <td><a href="hapus-data-pemetaan?id_daftar_sma=<?php echo $d['id_daftar_sma']; ?>" class="btn btn-danger" onclick="return confirm('Hapus Data ?');">Hapus</a></td>
                    </tr>
                    <?php } ?>
                    </table>
