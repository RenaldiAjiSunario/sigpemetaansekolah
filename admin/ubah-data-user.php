            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Content Row -->
                        ...
                        <form action="proses-ubah-user" method="post">
                        <?php 
                        include '../koneksi/koneksi.php';
                        $id_user = $_GET['id_user'];
                        $data_user = mysqli_query($koneksi,"select * from tb_user where id_user='$id_user' limit 1");
                        while($d = mysqli_fetch_array($data_user)){ ?>
                        <table class="table">
                            <tr>
                                <td colspan="2"><input type="hidden" value="<?php echo $d['id_user']; ?>" id="id_user" name="id_user" class="form-control"></td>
                            </tr>
                            <tr>
                                <td>Nama Lengkap</td><td><input type="text" value="<?php echo $d['nama_lengkap']; ?>" id="nama_lengkap" name="nama_lengkap" class="form-control" placeholder="masukan nama lengkap admin" required></td>
                            </tr>
                            <tr>
                                <td>Username</td><td><input type="text" value="<?php echo $d['username']; ?>" id="username" name="username" class="form-control" placeholder="masukan username" required></td>
                            </tr>
                            <tr>
                                <td>Password</td><td><input type="text" value="<?php echo $d['password']; ?>" id="password" name="password" class="form-control" placeholder="masukan password" required></td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <select name="tipe_user" id="tipe_user" class="form-control" required>
                                        <option value="<?php echo $d['tipe_user']; ?>">--Pilih Role--</option>
