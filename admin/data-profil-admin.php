        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    $data_admin = mysqli_query($koneksi,"select * from tb_user where id_user=$id_user");
                    while($d_admin = mysqli_fetch_array($data_admin)){ ?>
                    <table class="table">
                        <tr>
                            <td>Nama Admin</td><td><?php echo $d_admin['nama_lengkap'] ?></td>
                            <td rowspan="4"><img src="foto_profil/user.png" width="200" height="200" alt=""></td>
                        </tr>
                        <tr>
                            <td>Username</td><td><?php echo $d_admin['username'] ?></td>
                        </tr>
                        <tr>
                            <td>Password</td><td><?php echo $d_admin['password'] ?></td>
                        </tr>
                        <tr>
                            <td>Role</td><td><?php echo $d_admin['tipe_user'] ?></td>
                        </tr>
                    </table>
                    <?php } ?>
