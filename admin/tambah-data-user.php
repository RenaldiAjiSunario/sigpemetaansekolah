            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Content Row -->
                        ...
                        <form action="proses-tambah-user" method="post">
                        <table class="table">
                            <tr>
                                <td>Nama Lengkap</td><td><input type="text" id="nama_lengkap" name="nama_lengkap" class="form-control" placeholder="masukan nama lengkap admin" required></td>
                            </tr>
                            <tr>
                                <td>Username</td><td><input type="text" id="username" name="username" class="form-control" placeholder="masukan username" required></td>
                            </tr>
                            <tr>
                                <td>Password</td><td><input type="text" id="password" name="password" class="form-control" placeholder="masukan password" required></td>
                            </tr>
                            <tr>
                                <td colspan="2">
