    ...
    function GMPStart() {
        ...
        <?php
            ...
            while ($d_pemetaan = mysqli_fetch_array($data_pemetaan)) {
                ...
                $jalan = "<p> $alamat </p>";
                echo "addMarker($lat, $long, '$icon.$jalan.$link') \n";
            }
        ?>
        ...
        <?php
            ...
            $data_pemetaan = mysqli_query($koneksi,"select * from tb_daftar_sma where id_daftar_sma=$id_daftar_sma");
            while ($d_pemetaan = mysqli_fetch_array($data_pemetaan)) {
                $nama = $d_pemetaan["nama_sma"];
                $lat  = $d_pemetaan["lattitue"];
                $long = $d_pemetaan["longitude"];
        ...
        function addMarker(lat, lng, info) {
            ...
            // Membuka Info Window secara otomatis
